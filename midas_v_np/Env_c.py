...
# If time limit exceeds, change the position of the goal
# Define max number of goals to reach
...
class Env(gym.Env):
    ...
    def getState(self, scan, image):
        ...
        for i in range(0, n_samp):
            ...
            if cof == 1:
                n_i = i
            obs.append(spec_row[n_i]/255)

        self.laser = scan_range
        self.depth = obs
    ...
    def step(self, action):
        ...
        # print(f"Speed: {vel_cmd.linear.x} - Angle: {vel_cmd.angular.z}")
    ...
    def reset(self):
        ...
        self.previous_actions = [0, 0.2]
        state = state + self.previous_actions
